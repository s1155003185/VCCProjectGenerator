...
class VPGFileGenerationManager : public BaseManager<VPGFileGenerationManager>
{
    ...
    public:
        ...
        void GeneratePropertyClassFile(const LogProperty *logProperty, const std::wstring &filePrefix, const std::wstring &classPrefix, const std::wstring &hppFilePath, const std::vector<std::shared_ptr<VPGEnumClass>> &enumClassList);
