...
enum class VPGEnumClassAttributeProperty {
    ...
    ,
    IsType1Custom  // GETCUSTOM(bool, IsType1Custom, return
                   // vcc::isCapital(vcc::splitString(getType1(), {L"::"}).back());)
    ,
    Type2  // GETSET(std::wstring, Type2, L"")
    ,
    IsType2Custom  // GETCUSTOM(bool, IsType2Custom, return
                   // vcc::isCapital(vcc::splitString(getType2(), {L"::"}).back());)
    ,
    PropertyName  // GETSET(std::wstring, PropertyName, L"");
    ,
    Validate  // GETSET(std::wstring, Validate, L"")
    ,
    DefaultValue  // GETCUSTOM(std::wstring, DefaultValue, if (_InitializeProperties.empty()) return
                  // _DefaultValue; return vcc::concat(_InitializeProperties, L", ");)
    ...
    ,
    IsCustom  // GETCUSTOM(bool, IsCustom, return vcc::isContain(getMacro(), L"(") ?
              // vcc::isContain(_Macro.substr(0, _Macro.find(L"(")), L"CUSTOM") : false;)
    ,
    IsObject  // GETCUSTOM(bool, IsObject, return vcc::isContain(getMacro(), L"(") ?
              // vcc::isContain(_Macro.substr(0, _Macro.find(L"(")), L"_SPTR") : false;)
    ,
    ...
    ,
    IsSet  // GETCUSTOM(bool, IsSet, return vcc::isContain(std::vector<VPGEnumClassMacroType>{
           // VPGEnumClassMacroType::Set, VPGEnumClassMacroType::SetSptr,
           // VPGEnumClassMacroType::SetValidate, VPGEnumClassMacroType::SetValidateSptr },
           // _MacroType);)
    ,
    ...
    ,
    IsCollection  // GETCUSTOM(bool, IsCollection, return getIsVector() || getIsMap() ||
                  // getIsOrderedMap() || getIsSet();)
    ,
    IsHavingValidate  // GETCUSTOM(bool, IsHavingValidate, return vcc::isContain(getMacro(), L"(") ?
                      // vcc::isContain(_Macro.substr(0, _Macro.find(L"(")), L"VALIDATE") : false;)
    ...
    IsInitializeInClassConstructorNeeded /* GETCUSTOM(bool, IsInitializeInClassConstructorNeeded,
                                              return
                                            vcc::isContain(std::vector<VPGEnumClassMacroType>{VPGEnumClassMacroType::GetsetSptr,
                                            VPGEnumClassMacroType::ManagerSptr}, _MacroType)
                                                  ||
                                            (!vcc::isContain(std::vector<VPGEnumClassMacroType>{VPGEnumClassMacroType::Getcustom,
                                            VPGEnumClassMacroType::GetcustomSptr}, _MacroType) &&
                                            !_InitializeProperties.empty());)*/
};
