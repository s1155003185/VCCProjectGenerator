...
class VPGMainFormAddWorkspaceFormArgumentPropertyAccessor : public vcc::BasePropertyAccessor {
   ...
   public:
    VPGMainFormAddWorkspaceFormArgumentPropertyAccessor(std::shared_ptr<vcc::IObject> object)
...
class VPGMainFormDeleteWorkspaceFormArgumentPropertyAccessor : public vcc::BasePropertyAccessor {
   ...
   public:
    VPGMainFormDeleteWorkspaceFormArgumentPropertyAccessor(std::shared_ptr<vcc::IObject> object)
        : vcc::BasePropertyAccessor(object) {}
...
class VPGMainFormRenameWorkspaceFormArgumentPropertyAccessor : public vcc::BasePropertyAccessor {
   ...
   public:
    VPGMainFormRenameWorkspaceFormArgumentPropertyAccessor(std::shared_ptr<vcc::IObject> object)
        : vcc::BasePropertyAccessor(object) {}
...
class VPGMainFormPropertyAccessor : public vcc::BasePropertyAccessor {
   ...
   public:
    VPGMainFormPropertyAccessor(std::shared_ptr<vcc::IObject> object)
        : vcc::BasePropertyAccessor(object) {}
