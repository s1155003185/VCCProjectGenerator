...
class VPGBaseGenerationManager : public vcc::BaseManager, public IVPGGenerationManager {
   ...
   public:
    VPGBaseGenerationManager(std::shared_ptr<vcc::LogConfig> logConfig, std::wstring& workspace,
    ...
    void syncWorkspace(const vcc::LogConfig* logConfig, const std::wstring& sourceWorkspace,
                       const std::wstring& targetWorkspace,
                       const std::vector<std::wstring>& includeFileFilters,
