...
#define PROPERTY_ACCESSOR_DLL_EXPORT_MACRO_DETAIL(exportType, typeName, defaultValue) \
    ...
    { \
        TRY \
            ...
            return PropertyAccessorFactory::Create(object->SharedPtr())->Read##typeName(LockType::ReadLock, property); \
        CATCH \
        return defaultValue; \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            return PropertyAccessorFactory::Create(object->SharedPtr())->Read##typeName##AtIndex(LockType::ReadLock, property, index); \
        CATCH \
        return defaultValue; \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            return PropertyAccessorFactory::Create(object->SharedPtr())->Read##typeName##AtKey(LockType::ReadLock, property, key); \
        CATCH \
        return defaultValue; \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->Write##typeName(LockType::WriteLock, property, value); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->Write##typeName##AtIndex(LockType::WriteLock, property, value, index); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->Write##typeName##AtKey(LockType::WriteLock, property, value, key); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->Insert##typeName##AtIndex(LockType::WriteLock, property, value, index); \
        CATCH \
    }
...
#define PROPERTY_ACCESSOR_DLL_EXPORT_MACRO_DETAIL_STRING \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::wstring result = PropertyAccessorFactory::Create(object->SharedPtr())->ReadString(LockType::ReadLock, property); \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::wstring result = PropertyAccessorFactory::Create(object->SharedPtr())->ReadStringAtIndex(LockType::ReadLock, property, index); \
            size_t size = (result.length() + 1) * sizeof(wchar_t); \
            *value = static_cast<wchar_t*>(malloc(size)); \
            wcscpy(*value, result.c_str()); \
        CATCH \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::wstring result = PropertyAccessorFactory::Create(object->SharedPtr())->ReadStringAtKey(LockType::ReadLock, property, key); \
            size_t size = (result.length() + 1) * sizeof(wchar_t); \
            *value = static_cast<wchar_t*>(malloc(size)); \
            wcscpy(*value, result.c_str()); \
        CATCH \
    ...
    { \
        TRY \
            ...
            { \
                ...
                PropertyAccessorFactory::Create(object->SharedPtr())->WriteString(LockType::WriteLock, property, *value); \
            } \
        CATCH \
    } \
    ...
    { \
        TRY \
            ...
            { \
                IObject *object = static_cast<IObject *>(ref); \
                auto ptr = object->SharedPtr();\
                PropertyAccessorFactory::Create(object->SharedPtr())->WriteStringAtIndex(LockType::WriteLock, property, *value, index); \
            } \
        CATCH \
    } \
    ...
    { \
        TRY \
            ...
            { \
                IObject *object = static_cast<IObject *>(ref); \
                PropertyAccessorFactory::Create(object->SharedPtr())->WriteStringAtKey(LockType::WriteLock, property, *value, key); \
            } \
        CATCH \
    } \
    ...
    { \
        TRY \
            ...
            { \
                IObject *object = static_cast<IObject *>(ref); \
                PropertyAccessorFactory::Create(object->SharedPtr())->InsertStringAtIndex(LockType::WriteLock, property, *value, index); \
            } \
        CATCH \
    }
...
#define PROPERTY_ACCESSOR_DLL_EXPORT_MACRO_DETAIL_OBJECT \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::shared_ptr<IObject> result = PropertyAccessorFactory::Create(object->SharedPtr())->ReadObject(LockType::ReadLock, property); \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::shared_ptr<IObject> result = PropertyAccessorFactory::Create(object->SharedPtr())->ReadObjectAtIndex(LockType::ReadLock, property, index); \
            return result != nullptr ? result.get() : nullptr; \
        CATCH \
        return nullptr; \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::shared_ptr<IObject> result = PropertyAccessorFactory::Create(object->SharedPtr())->ReadObjectAtKey(LockType::ReadLock, property, key); \
            return result != nullptr ? result.get() : nullptr; \
        CATCH \
        return nullptr; \
    } \
    ...
    { \
        TRY \
            ...
            PropertyAccessorFactory::Create(object->SharedPtr())->WriteObject(LockType::WriteLock, property, resultPtr); \
        CATCH \
    } \
    DLLEXPORT void WriteObjectAtIndex(void *ref, int64_t property, void *value, int64_t index) \
    { \
        TRY \
            ...
            IObject *result = static_cast<IObject *>(value); \
            std::shared_ptr<IObject> resultPtr(result); \
            PropertyAccessorFactory::Create(object->SharedPtr())->WriteObjectAtIndex(LockType::WriteLock, property, resultPtr, index); \
        CATCH \
    } \
    DLLEXPORT void WriteObjectAtKey(void *ref, int64_t property, void *value, void *key) \
    { \
        TRY \
            ...
            IObject *result = static_cast<IObject *>(value); \
            std::shared_ptr<IObject> resultPtr(result); \
            PropertyAccessorFactory::Create(object->SharedPtr())->WriteObjectAtKey(LockType::WriteLock, property, resultPtr, key); \
        CATCH \
    } \
    DLLEXPORT void *AddObjectAtIndex(void *ref, int64_t property, int64_t objectType, int64_t index) \
    { \
        TRY \
            ...
            PropertyAccessorFactory::Create(object->SharedPtr())->InsertObjectAtIndex(LockType::WriteLock, property, newObject, index); \
    ...
    { \
        TRY \
            ...
            IObject *result = static_cast<IObject *>(value); \
            std::shared_ptr<IObject> resultPtr(result); \
            PropertyAccessorFactory::Create(object->SharedPtr())->InsertObjectAtIndex(LockType::WriteLock, property, resultPtr, index); \
        CATCH \
    }
...
#define PROPERTY_ACCESSOR_DLL_EXPORT_MACRO_DETAIL_CONTAINER \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            return PropertyAccessorFactory::Create(object->SharedPtr())->GetCount(LockType::ReadLock, property); \
        CATCH \
        return 0; \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            std::set<void *> result = PropertyAccessorFactory::Create(object->SharedPtr())->GetMapKeys(LockType::ReadLock, property); \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            return PropertyAccessorFactory::Create(object->SharedPtr())->IsContainKey(LockType::ReadLock, property, key); \
        CATCH \
        return false; \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->Remove(LockType::WriteLock, property, value); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->RemoveObject(LockType::WriteLock, property, static_cast<IObject *>(value)); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->RemoveAtIndex(LockType::WriteLock, property, index); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            PropertyAccessorFactory::Create(object->SharedPtr())->RemoveAtKey(LockType::WriteLock, property, key); \
        CATCH \
    } \
    ...
    { \
        TRY \
            IObject *object = static_cast<IObject *>(ref); \
            return PropertyAccessorFactory::Create(object->SharedPtr())->Clear(LockType::WriteLock, property); \
        CATCH \
    }
