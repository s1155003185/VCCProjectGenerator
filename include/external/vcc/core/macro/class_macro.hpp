...
namespace vcc
{
    ...
    public: \
        void Set##varName(const type &value) const { customProcedcure }
    ...
    public: \
        void Set##varName(std::shared_ptr<type> value) const { customProcedcure }
    ...
    public: \
        void Set##varName(const type &value) const { Validate##varName(value); _##varName = value; }
    ...
    #define GETSET_VALIDATE_SPTR_NULL(type, varName, validate) \
        ...
        public: \
            ...
            void Set##varName(std::shared_ptr<type> value) const { Validate##varName(value); _##varName = value; } \
    ...
    public: \
        ...
        void Set##varName##AtIndex(const int64_t &index, const type &value) const { Validate##varName(value); Set(_##varName, value, index); } \
        int64_t Find##varName(const type &value) const { return Find(_##varName, value); } \
        void Insert##varName(const type &value) const { Validate##varName(value); Insert(_##varName, value); } \
        void Insert##varName##AtIndex(const int64_t &index, const type &value) const { Validate##varName(value); Insert(_##varName, value, index); } \
        void Insert##varName(const std::vector<type> &value) const { for (auto const &element : value) Validate##varName(element); Insert(_##varName, value); } \
        void Insert##varName##AtIndex(const int64_t &index, const std::vector<type> &value) const { for (auto const &element : value) Validate##varName(element); Insert(_##varName, value, index); } \
    ...
    public: \
        ...
        void Set##varName##AtIndex(int64_t index, std::shared_ptr<IObject> value) const { Validate##varName(value); SetIObject(_##varName, value, index); } \
        int64_t Find##varName(const std::shared_ptr<IObject> value) const { return FindIObject(_##varName, value.get()); } \
        void Insert##varName(std::shared_ptr<IObject> value) const { Validate##varName(value); InsertIObject(_##varName, value); } \
        void Insert##varName##AtIndex(int64_t index, std::shared_ptr<IObject> value) const { Validate##varName(value); InsertIObject(_##varName, value, index); } \
        void Insert##varName(std::vector<std::shared_ptr<type>> &value) { for (auto const &element : value) Validate##varName(element); InsertIObjects(_##varName, value); } \
        ...
        std::vector<std::shared_ptr<type>> Clone##varName() { std::vector<std::shared_ptr<type>> result; for (auto &element : _##varName) { result.push_back(std::static_pointer_cast<type>(element->Clone())); } return result; } \
    ...
    public: \
        ...
        void Insert##varName(std::shared_ptr<type> value) const { Validate##varName(value); _##varName.insert(value); } \
        ...
        void Clone##varName(const std::set<std::shared_ptr<type>> &value) const { _##varName.clear(); for (std::shared_ptr<type> element : value) { Insert##varName(element != nullptr ? std::dynamic_pointer_cast<type>(element->Clone()) : nullptr); } }\
        void Clear##varName() const { _##varName.clear(); }
    ...
    public: \
        ...
        void Set##varName##AtKey(keyType key, valueType value) const { Validate##varName(value); Set(_##varName, key, value); } \
        void Insert##varName##AtKey(keyType key, valueType value) const { Validate##varName(value); Set(_##varName, key, value); } \
        void Insert##varName(const std::pair<keyType, valueType> &value) const { Validate##varName(value.second); Set(_##varName, value.first, value.second); } \
        void Insert##varName(const std::map<keyType, valueType> &value) const { for (auto const &pair : value) Validate##varName(pair.second); Set(_##varName, value); } \
        std::map<keyType, valueType> Clone##varName() const { return _##varName; } \
        void Clone##varName(const std::map<keyType, valueType> &value) const { _##varName.clear(); Insert##varName(value); } \
    ...
    public: \
        ...
        void Set##varName##AtKey(keyType key, std::shared_ptr<valueType> value) const { Validate##varName(value); SetIObject(_##varName, key, value); } \
        void Insert##varName##AtKey(keyType key, std::shared_ptr<valueType> value) const { Validate##varName(value); SetIObject(_##varName, key, value); } \
        void Insert##varName(const std::pair<keyType, std::shared_ptr<valueType>> &value) const { Validate##varName(value.second); SetIObject(_##varName, value.first, value.second); } \
        void Insert##varName(const std::map<keyType, std::shared_ptr<valueType>> &value) const { for (auto const &pair : value) Validate##varName(pair.second); SetIObjects(_##varName, value); } \
        ...
        void Clone##varName(const std::map<keyType, std::shared_ptr<valueType>> &value) const { _##varName.clear(); for (auto const& element : value) { Insert##varName##AtKey(element.first, element.second != nullptr ? std::dynamic_pointer_cast<valueType>(element.second->Clone()) : nullptr); } }\
    ...
    public: \
        ...
        void Set##varName##AtIndex(int64_t index, std::pair<keyType, valueType> value) const { Validate##varName(value.second); _##varName[index] = value; } \
        void Set##varName##AtKey(keyType key, valueType value) const { for (auto &pair : _##varName) {  Validate##varName(value); if (pair.first == key) { pair.second = value; return; } } Insert##varName##AtKey(key, value); } \
        ...
        void Insert##varName##AtIndex(int64_t index, std::pair<keyType, valueType> value) const { Validate##varName(value.second); Insert(_##varName, value, index); } \
        void Insert##varName##AtKey(keyType key, valueType value) const { Validate##varName(value); _##varName.push_back(std::make_pair(key, value)); } \
        void Insert##varName(const std::pair<keyType, valueType> value) const { Validate##varName(value.second); _##varName.push_back(value); } \
        void Insert##varName(const std::vector<std::pair<keyType, valueType>> &value) const { for (auto const &pair : value) Validate##varName(pair.second); _##varName.insert(_##varName.end(), value.begin(), value.end()); } \
        std::vector<std::pair<keyType, valueType>> Clone##varName() const { return _##varName; } \
        void Clone##varName(const std::vector<std::pair<keyType, valueType>> &value) const { _##varName.clear(); Insert##varName(value); } \
    ...
    public: \
        ...
        int64_t Find##varName(keyType key) const { for (size_t i = 0; i < _##varName.size(); i++) { if (_##varName[i].first == key) return i; } return -1; } \
        bool Is##varName##ContainKey(keyType key) const { return Find##varName(key) > -1; } \
        void Set##varName##AtIndex(int64_t index, std::pair<keyType, std::shared_ptr<valueType>> value) const { Validate##varName(value.second); _##varName[index] = value; } \
        void Set##varName##AtKey(keyType key, std::shared_ptr<valueType> value) const { for (auto &pair : _##varName) { Validate##varName(value); if (pair.first == key) { pair.second = value; return; } } Insert##varName##AtKey(key, value); } \
        void Insert##varName##AtIndex(int64_t index, std::pair<keyType, std::shared_ptr<valueType>> value) const { Validate##varName(value.second); Insert(_##varName, value, index); } \
        void Insert##varName##AtKey(keyType key, std::shared_ptr<valueType> value) const { Validate##varName(value); _##varName.push_back(std::make_pair(key, value)); } \
        void Insert##varName(const std::pair<keyType, std::shared_ptr<valueType>> value) const { Validate##varName(value.second); _##varName.push_back(value); } \
        void Insert##varName(const std::vector<std::pair<keyType, std::shared_ptr<valueType>>> &value) const { for (auto const &pair : value) Validate##varName(pair.second); _##varName.insert(_##varName.end(),value.begin(), value.end()); } \
        ...
        std::shared_ptr<valueType> Clone##varName##AtKey(keyType key) const { return std::static_pointer_cast<valueType>(Get##varName##AtKey(key)->Clone()); } \
        void Clone##varName(const std::vector<std::pair<keyType, std::shared_ptr<valueType>>> &value) const { _##varName.clear(); for (auto const& element : value) { Insert##varName##AtKey(element.first, element.second != nullptr ? std::dynamic_pointer_cast<valueType>(element.second->Clone()) : nullptr); } }\
        void Remove##varName##AtIndex(int64_t index) { if (index >= 0) { _##varName.erase(_##varName.begin() + (size_t)index); } } \
        void Remove##varName##AtKey(keyType key) { int64_t index = Find##varName(key); if (index >= 0) (_##varName.erase(_##varName.begin() + (size_t)(Find##varName(key)))); } \
        void Clear##varName() const { _##varName.clear(); }
    ...
    public: \
        std::shared_ptr<type> Get##varName() const { return _##varName; } \
        void Set##varName(std::shared_ptr<type> value) const { _##varName = value; }
