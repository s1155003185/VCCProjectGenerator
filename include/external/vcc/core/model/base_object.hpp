...
class BaseObject : public IObject {
   ...
   public:
    virtual size_t getObjectId() const override { return _ObjectId; }

    virtual const ObjectType& getObjectType() const override { return _ObjectType; }

    virtual std::shared_ptr<IObject> getParentObject() const override { return _ParentObject; }
