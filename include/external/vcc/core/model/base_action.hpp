...
class BaseAction : public IAction, public BaseObject {
   protected:
    ...
    virtual std::shared_ptr<IResult> onUndo() override {
        THROW_EXCEPTION_MSG(ExceptionType::NotImplement, L"OnUndo() has not been implemented");
        return nullptr;
    };
    virtual std::wstring getUndoMessageStart() const override {
        THROW_EXCEPTION_MSG(ExceptionType::NotImplement,
                            L"GetUndoMessageStart() has not been implemented");
        return L"";
    }
    virtual std::wstring getUndoMessageComplete() const override {
        THROW_EXCEPTION_MSG(ExceptionType::NotImplement,
                            L"GetUndoMessageComplete() has not been implemented");
        return L"";
    }
