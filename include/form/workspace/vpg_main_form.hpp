...
class VPGMainFormAddWorkspaceFormArgument : public vcc::BaseActionArgument {
   ...
   public:
    VPGMainFormAddWorkspaceFormArgument()
        : vcc::BaseActionArgument(ObjectType::MainFormAddWorkspaceFormArgument) {}
...
class VPGMainFormDeleteWorkspaceFormArgument : public vcc::BaseActionArgument {
   ...
   public:
    VPGMainFormDeleteWorkspaceFormArgument()
        : vcc::BaseActionArgument(ObjectType::MainFormDeleteWorkspaceFormArgument) {}
...
class VPGMainFormRenameWorkspaceFormArgument : public vcc::BaseActionArgument {
   ...
   public:
    VPGMainFormRenameWorkspaceFormArgument()
        : vcc::BaseActionArgument(ObjectType::MainFormRenameWorkspaceFormArgument) {}
...
class VPGMainFormAddWorkspaceForm : public vcc::BaseAction {
   ...
   public:
    ...
    VPGMainFormAddWorkspaceForm(std::shared_ptr<vcc::LogConfig> logConfig,
...
class VPGMainFormDeleteWorkspaceForm : public vcc::BaseAction {
   ...
   public:
    ...
    VPGMainFormDeleteWorkspaceForm(std::shared_ptr<vcc::LogConfig> logConfig,
                                   std::shared_ptr<vcc::IObject> parentForm);
...
class VPGMainFormInitialize : public vcc::BaseAction {
   ...
   public:
    ...
    VPGMainFormInitialize(std::shared_ptr<vcc::LogConfig> logConfig,
                          std::shared_ptr<vcc::IObject> parentForm);
...
class VPGMainFormRenameWorkspaceForm : public vcc::BaseAction {
   ...
   public:
    ...
    VPGMainFormRenameWorkspaceForm(std::shared_ptr<vcc::LogConfig> logConfig,
                                   std::shared_ptr<vcc::IObject> parentForm);
