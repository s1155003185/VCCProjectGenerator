...
class VPGConfig : public vcc::BaseObject, public vcc::BaseJsonObject {
    ...
    GETCUSTOM(std::wstring, TemplateUrl,
              return this->getTemplate() != nullptr
                         ? this->getTemplate()->getUrl()
                         : std::make_shared<VPGConfigTemplate>()->getUrl();)
    GETCUSTOM(std::wstring, TemplateWorkspace,
              return this->getTemplate() != nullptr
                         ? this->getTemplate()->getWorkspace()
                         : std::make_shared<VPGConfigTemplate>()->getWorkspace();)
    GETCUSTOM(bool, TemplateIsExcludeUnittest,
              return this->getTemplate() != nullptr
                         ? this->getTemplate()->getIsExcludeUnittest()
                         : std::make_shared<VPGConfigTemplate>()->getIsExcludeUnittest();)
    GETCUSTOM(bool, TemplateIsExcludeVCCUnitTest,
              return this->getTemplate() != nullptr
    ...
    GETCUSTOM(VPGConfigActionHistoryType, BehaviorActionHistoryType,
    ...
    GETCUSTOM(
        bool, BehaviorIsActionResultThrowException,
        return this->getBehavior() != nullptr
    ...
    GETCUSTOM(std::wstring, InputTypeWorkspace,
              return this->getInput() != nullptr
                         ? this->getInput()->getTypeWorkspace()
                         : std::make_shared<VPGConfigInput>()->getTypeWorkspace();)
    GETSET_SPTR(VPGConfigOutput, Output)
    GETCUSTOM(std::wstring, OutputExceptionTypeDirectory,
    ...
    GETCUSTOM(
        std::wstring, OutputPropertyAccessorFactoryDirectoryCpp,
        return this->getOutput() != nullptr
    ...
    GETCUSTOM(std::wstring, OutputUnittestActionDirectoryCpp,
              return (this->getOutput() != nullptr && this->getOutput()->getUnittest() != nullptr)
