...
class Application : public vcc::BaseForm {
   ...
   public:
    ...
    static std::shared_ptr<vcc::IObject> doFormAction(vcc::IObject* form,
    ...
    virtual std::shared_ptr<vcc::IResult> doAction(
        const int64_t& /*formProperty*/, std::shared_ptr<vcc::IObject> /*argument*/) override {
        return nullptr;
    }
