...
enum class VPGFileContentGenerationMode { NA, Force, Demand, Skip };
...
class VPGFileGenerationService {
   private:
    ...
    static std::wstring generateForceCode(const vcc::Xml* src, const std::wstring& tagName,
                                          const std::wstring& generatedContent,
                                          const std::wstring& commandDelimiter);
    static std::wstring generateDemandCode(const vcc::Xml* src, const std::wstring& tagName,
                                           const std::wstring& generatedContent,
                                           const std::wstring& commandDelimiter);
   ...
   public:
    ...
    static std::wstring generateFileContent(const std::wstring& code, const std::wstring& tagName,
                                            const std::wstring& generatedContent,
                                            const std::wstring& commandDelimiter);
};