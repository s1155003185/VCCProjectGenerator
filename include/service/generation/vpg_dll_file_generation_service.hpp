...
class VPGDllFileGenerationService {
   private:
    ...
    static std::wstring generateApplicationCpp(const VPGDllFileGenerationServiceOption* option,
                                               std::set<std::wstring>& customIncludeFiles);

    static std::wstring generatePropertyAccessorHpp(const VPGDllFileGenerationServiceOption* option,
                                                    std::set<std::wstring>& customIncludeFiles);
    static std::wstring generatePropertyAccessorCpp(const VPGDllFileGenerationServiceOption* option,
                                                    std::set<std::wstring>& customIncludeFiles);
   ...
   public:
    ...
    static void generateCpp(const vcc::LogConfig* logConfig, const std::wstring& filePathCpp,
                            const VPGDllFileGenerationServiceOption* option);
};