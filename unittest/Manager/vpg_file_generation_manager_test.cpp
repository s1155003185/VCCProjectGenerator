...
TEST_F(VPGFileGenerationManagerTest, GenerateProperty)
{
    ...
    EXPECT_EQ(ReadFile(ConcatPaths({this->GetWorkspaceTarget(), L"vcc_a_property_accessor.cpp"})),
        ...
        "}\r\n"
        "\r\n"
        "long VCCObjectPropertyAccessor::_ReadLong(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_WriteLong(const int64_t &objectProperty, const long & /*value*/, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::wstring VCCObjectPropertyAccessor::_ReadString(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_WriteString(const int64_t &objectProperty, const std::wstring & /*value*/, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "bool VCCObjectPropertyAccessor::_IsContainKey(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::shared_ptr<IObject> VCCObjectPtrPropertyAccessor::_ReadObject(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_WriteObject(const int64_t &objectProperty, std::shared_ptr<IObject> /*value*/, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::shared_ptr<IObject> VCCObjectPtrPropertyAccessor::_CloneObject(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "bool VCCObjectPtrPropertyAccessor::_IsContainKey(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const ITypeUnion * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
