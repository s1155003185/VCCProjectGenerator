...
TEST_F(VPGJavaGenerationServiceTest, GenerateJavaBridge)
{
    ...
    EXPECT_EQ(ReadFile(ConcatPaths({this->GetWorkspace(), this->GetJavaOption()->GetDllBridgeDirectory(), L"VPGDllFunctions.java"})),
        ...
        "    PointerByReference CreateObject(long property);\r\n"
        "    boolean ReadBool(PointerByReference ref, long property, long index);\r\n"
        "    byte ReadChar(PointerByReference ref, long property, long index);\r\n"
        "    byte ReadCharByKey(PointerByReference ref, long property, Pointer key);\r\n"
        "    void WriteChar(PointerByReference ref, long property, byte value, long index);\r\n"
        "    void WriteCharByKey(PointerByReference ref, long property, byte value, Pointer key);\r\n"
        "    void InsertChar(PointerByReference ref, long property, byte value, long index);\r\n"
        "    void ReadString(PointerByReference ref, long property, PointerByReference value, long index);\r\n"
        "    void ReadStringByKey(PointerByReference ref, long property, PointerByReference value, Pointer key);\r\n"
        "    void WriteString(PointerByReference ref, long property, PointerByReference value, long index);\r\n"
        "    void WriteStringByKey(PointerByReference ref, long property, PointerByReference value, Pointer key);\r\n"
        "    void InsertString(PointerByReference ref, long property, PointerByReference value, long index);\r\n"
        "    PointerByReference ReadObject(PointerByReference ref, long property, long index);\r\n"
        "    PointerByReference ReadObjectByKey(PointerByReference ref, long property, Pointer key);\r\n"
        "    void WriteObject(PointerByReference ref, long property, PointerByReference value, long index);\r\n"
        "    void WriteObjectByKey(PointerByReference ref, long property, PointerByReference value, Pointer key);\r\n"
        "    PointerByReference AddObject(PointerByReference ref, long property, long objectType, long index);\r\n"
        "    void InsertObject(PointerByReference ref, long property, PointerByReference value, long index);\r\n"
        "    long GetContainerCount(PointerByReference ref, long property);\r\n"
        "    Pointer GetMapKeys(PointerByReference ref, long property);\r\n"
        "    boolean IsContainKey(PointerByReference ref, long property, Pointer key);\r\n"
        "    void RemoveContainerElement(PointerByReference ref, long property, long index);\r\n"
        "    void RemoveContainerElementByKey(PointerByReference ref, long property, Pointer key);\r\n"
        "    void ClearContainer(PointerByReference ref, long property);\r\n"
        "}\r\n"
        );
}
...
{   
    ...
    EXPECT_EQ(ReadFile(filePath),
        ...
        "        return VPGDllFunctions.Instance.ReadBool(Reference, VPGTypeBProperty.Bool.getValue(), -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setBool(boolean value) {\r\n"
        "        VPGDllFunctions.Instance.WriteBool(Reference, VPGTypeBProperty.Bool.getValue(), value, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getLong() {\r\n"
        "        return VPGDllFunctions.Instance.ReadLong(Reference, VPGTypeBProperty.Long.getValue(), -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setLong(long value) {\r\n"
        "        VPGDllFunctions.Instance.WriteLong(Reference, VPGTypeBProperty.Long.getValue(), value, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public float getFloat() {\r\n"
        "        return VPGDllFunctions.Instance.ReadFloat(Reference, VPGTypeBProperty.Float.getValue(), -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setFloat(float value) {\r\n"
        "        VPGDllFunctions.Instance.WriteFloat(Reference, VPGTypeBProperty.Float.getValue(), value, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public byte getChar() {\r\n"
        "        return VPGDllFunctions.Instance.ReadChar(Reference, VPGTypeBProperty.Char.getValue(), -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setChar(byte value) {\r\n"
        "        VPGDllFunctions.Instance.WriteChar(Reference, VPGTypeBProperty.Char.getValue(), value, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public char getWChar() {\r\n"
        "        return VPGDllFunctions.Instance.ReadWchar(Reference, VPGTypeBProperty.WChar.getValue(), -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setWChar(char value) {\r\n"
        "        VPGDllFunctions.Instance.WriteWchar(Reference, VPGTypeBProperty.WChar.getValue(), value, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public String getString() {\r\n"
        "        PointerByReference result = new PointerByReference();\r\n"
        "        VPGDllFunctions.Instance.ReadString(Reference, VPGTypeBProperty.String.getValue(), result, -1);\r\n"
        ...
        "        VPGDllFunctions.Instance.WriteString(Reference, VPGTypeBProperty.String.getValue(), valueReference, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public VPGTypeBProperty getEnum() {\r\n"
        "        return VPGTypeBProperty.parse((int)VPGDllFunctions.Instance.ReadLong(Reference, VPGTypeBProperty.Enum.getValue(), -1));\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setEnum(VPGTypeBProperty value) {\r\n"
        "        VPGDllFunctions.Instance.WriteLong(Reference, VPGTypeBProperty.Enum.getValue(), value.getValue(), -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public VPGTypeB getObject() {\r\n"
        "        return new VPGTypeB(VPGDllFunctions.Instance.ReadObject(Reference, VPGTypeBProperty.Object.getValue(), -1));\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setObject(VPGTypeB value) {\r\n"
        "        VPGDllFunctions.Instance.WriteObject(Reference, VPGTypeBProperty.Object.getValue(), value.Reference, -1);\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getVectorDoubleCount() {\r\n"
        "        return VPGDllFunctions.Instance.GetContainerCount(Reference, VPGTypeBProperty.VectorDouble.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public double getVectorDoubleAt(long index) {\r\n"
        "        return VPGDllFunctions.Instance.ReadDouble(Reference, VPGTypeBProperty.VectorDouble.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setVectorDoubleAt(long index, double value) {\r\n"
        "        VPGDllFunctions.Instance.WriteDouble(Reference, VPGTypeBProperty.VectorDouble.getValue(), value, index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        VPGDllFunctions.Instance.InsertDouble(Reference, VPGTypeBProperty.VectorDouble.getValue(), value, index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeVectorDoubleAt(long index) {\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElement(Reference, VPGTypeBProperty.VectorDouble.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void clearVectorDouble() {\r\n"
        "        VPGDllFunctions.Instance.ClearContainer(Reference, VPGTypeBProperty.VectorDouble.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getVectorStringCount() {\r\n"
        "        return VPGDllFunctions.Instance.GetContainerCount(Reference, VPGTypeBProperty.VectorString.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public String getVectorStringAt(long index) {\r\n"
        "        PointerByReference result = new PointerByReference();\r\n"
        "        VPGDllFunctions.Instance.ReadString(Reference, VPGTypeBProperty.VectorString.getValue(), result, index);\r\n"
        "        return result.getValue().getWideString(0);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        PointerByReference valueReference = new PointerByReference();\r\n"
        "        valueReference.setValue(valuePtr);\r\n"
        "        VPGDllFunctions.Instance.WriteString(Reference, VPGTypeBProperty.VectorString.getValue(), valueReference, index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        PointerByReference valueReference = new PointerByReference();\r\n"
        "        valueReference.setValue(valuePtr);\r\n"
        "        VPGDllFunctions.Instance.InsertString(Reference, VPGTypeBProperty.VectorString.getValue(), valueReference, index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeVectorStringAt(long index) {\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElement(Reference, VPGTypeBProperty.VectorString.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void clearVectorString() {\r\n"
        "        VPGDllFunctions.Instance.ClearContainer(Reference, VPGTypeBProperty.VectorString.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getMapCount() {\r\n"
        "        return VPGDllFunctions.Instance.GetContainerCount(Reference, VPGTypeBProperty.Map.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public double getMapByKey(int key) {\r\n"
        "        Pointer keyPtr = new Memory(Native.getNativeSize(int.class));\r\n"
        "        keyPtr.setInt(0, key);\r\n"
        "        return VPGDllFunctions.Instance.ReadDoubleByKey(Reference, VPGTypeBProperty.Map.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setMapByKey(int key, double value) {\r\n"
        "        Pointer keyPtr = new Memory(Native.getNativeSize(int.class));\r\n"
        "        keyPtr.setInt(0, key);\r\n"
        "        VPGDllFunctions.Instance.WriteIntByKey(Reference, VPGTypeBProperty.Map.getValue(), value, keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public Set<Integer> getMapKeys() {\r\n"
        "        Set<Integer> result = new HashSet<>();\r\n"
        "        Pointer ptrs = VPGDllFunctions.Instance.GetMapKeys(Reference, VPGTypeBProperty.Map.getValue());\r\n"
        ...
        "        Pointer keyPtr = new Memory(Native.getNativeSize(int.class));\r\n"
        "        keyPtr.setInt(0, key);\r\n"
        "        return VPGDllFunctions.Instance.IsContainKey(Reference, VPGTypeBProperty.Map.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeMapByKey(int key) {\r\n"
        "        Pointer keyPtr = new Memory(Native.getNativeSize(int.class));\r\n"
        "        keyPtr.setInt(0, key);\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElementByKey(Reference, VPGTypeBProperty.Map.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void clearMap() {\r\n"
        "        VPGDllFunctions.Instance.ClearContainer(Reference, VPGTypeBProperty.Map.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getVectorObjectCount() {\r\n"
        "        return VPGDllFunctions.Instance.GetContainerCount(Reference, VPGTypeBProperty.VectorObject.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public VPGTypeB getVectorObjectAt(long index) {\r\n"
        "        return new VPGTypeB(VPGDllFunctions.Instance.ReadObject(Reference, VPGTypeBProperty.VectorObject.getValue(), index));\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setVectorObjectAt(long index, VPGTypeB value) {\r\n"
        "        VPGDllFunctions.Instance.WriteObject(Reference, VPGTypeBProperty.VectorObject.getValue(), value.Reference, index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        return new VPGTypeB(VPGDllFunctions.Instance.AddObject(Reference, VPGTypeBProperty.VectorObject.getValue(), VPGObjectType.TypeB.getValue(), index));\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        VPGDllFunctions.Instance.InsertObject(Reference, VPGTypeBProperty.VectorObject.getValue(), value.Reference, index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeVectorObjectAt(long index) {\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElement(Reference, VPGTypeBProperty.VectorObject.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void clearVectorObject() {\r\n"
        "        VPGDllFunctions.Instance.ClearContainer(Reference, VPGTypeBProperty.VectorObject.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getMapObjectCount() {\r\n"
        "        return VPGDllFunctions.Instance.GetContainerCount(Reference, VPGTypeBProperty.MapObject.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        return new VPGTypeB(VPGDllFunctions.Instance.ReadObjectByKey(Reference, VPGTypeBProperty.MapObject.getValue(), keyPtr));\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setMapObjectByKey(String key, VPGTypeB value) {\r\n"
        "        Pointer keyPtr = new Memory(Native.WCHAR_SIZE * (key.length() + 1));\r\n"
        "        keyPtr.setWideString(0, key);\r\n"
        "        VPGDllFunctions.Instance.WriteObjectByKey(Reference, VPGTypeBProperty.MapObject.getValue(), value.Reference, keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public Set<String> getMapObjectKeys() {\r\n"
        "        Set<String> result = new HashSet<>();\r\n"
        "        Pointer ptrs = VPGDllFunctions.Instance.GetMapKeys(Reference, VPGTypeBProperty.MapObject.getValue());\r\n"
        ...
        "        Pointer keyPtr = new Memory(Native.WCHAR_SIZE * (key.length() + 1));\r\n"
        "        keyPtr.setWideString(0, key);\r\n"
        "        return VPGDllFunctions.Instance.IsContainKey(Reference, VPGTypeBProperty.MapObject.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeMapObjectByKey(String key) {\r\n"
        "        Pointer keyPtr = new Memory(Native.WCHAR_SIZE * (key.length() + 1));\r\n"
        "        keyPtr.setWideString(0, key);\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElementByKey(Reference, VPGTypeBProperty.MapObject.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void clearMapObject() {\r\n"
        "        VPGDllFunctions.Instance.ClearContainer(Reference, VPGTypeBProperty.MapObject.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public long getOrderedMapObjectCount() {\r\n"
        "        return VPGDllFunctions.Instance.GetContainerCount(Reference, VPGTypeBProperty.OrderedMapObject.getValue());\r\n"
        "    }\r\n"
        "\r\n"
        "    public double getOrderedMapObjectAt(long index) {\r\n"
        "        return new double(VPGDllFunctions.Instance.ReadObject(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), index));\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setOrderedMapObjectAt(long index, double value) {\r\n"
        "        VPGDllFunctions.Instance.WriteObject(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), value.Reference, index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        return new double(VPGDllFunctions.Instance.AddObject(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), VPGObjectType.double.getValue(), index));\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        return new VPGTypeB(VPGDllFunctions.Instance.ReadObjectByKey(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), keyPtr));\r\n"
        "    }\r\n"
        "\r\n"
        "    public void setOrderedMapObjectByKey(double key, VPGTypeB value) {\r\n"
        "        Pointer keyPtr = new Memory(Native.getNativeSize(double.class));\r\n"
        "        keyPtr.setDouble(0, key);\r\n"
        "        VPGDllFunctions.Instance.WriteObjectByKey(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), value.Reference, keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        VPGDllFunctions.Instance.InsertObject(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), value.Reference, index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public Set<Double> getOrderedMapObjectKeys() {\r\n"
        "        Set<Double> result = new HashSet<>();\r\n"
        "        Pointer ptrs = VPGDllFunctions.Instance.GetMapKeys(Reference, VPGTypeBProperty.OrderedMapObject.getValue());\r\n"
        ...
        "        Pointer keyPtr = new Memory(Native.getNativeSize(double.class));\r\n"
        "        keyPtr.setDouble(0, key);\r\n"
        "        return VPGDllFunctions.Instance.IsContainKey(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeOrderedMapObjectAt(long index) {\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElement(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void removeOrderedMapObjectByKey(double key) {\r\n"
        "        Pointer keyPtr = new Memory(Native.getNativeSize(double.class));\r\n"
        "        keyPtr.setDouble(0, key);\r\n"
        "        VPGDllFunctions.Instance.RemoveContainerElementByKey(Reference, VPGTypeBProperty.OrderedMapObject.getValue(), keyPtr);\r\n"
        "    }\r\n"
        "\r\n"
        "    public void clearOrderedMapObject() {\r\n"
        "        VPGDllFunctions.Instance.ClearContainer(Reference, VPGTypeBProperty.OrderedMapObject.getValue());\r\n"
        "    }\r\n"
        "}\r\n");
}
