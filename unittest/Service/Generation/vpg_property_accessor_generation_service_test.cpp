...
TEST_F(VPGPropertyAccessorFileGenerationServiceTest, Object)
{
    ...
    "        {\r\n"
    "        case VPGObjectProperty::Object:\r\n"
    "            return std::static_pointer_cast<IObject>(obj->CloneObject());\r\n"
    "        default:\r\n"
    "            assert(false);\r\n"
    "        }\r\n"
    "    CATCH\r\n"
...
TEST_F(VPGPropertyAccessorFileGenerationServiceTest, Container)
{
    ...
    "        case VPGObjectProperty::VectorEnum:\r\n"
    "            if (index > -1)\r\n"
    "                obj->SetVectorEnum(index, value);\r\n"
    "            else\r\n"
    "                obj->InsertVectorEnum(value);\r\n"
    "            break;\r\n"
    "        case VPGObjectProperty::OrderedMapEnum:\r\n"
    "            if (index > -1)\r\n"
    "                obj->SetOrderedMapEnumByIndex(index, value);\r\n"
    "            else\r\n"
    "                obj->InsertOrderedMapEnum(value);\r\n"
    "            break;\r\n"
    "        default:\r\n"
    "            assert(false);\r\n"
    "        }\r\n"
    ...
    "                obj->SetMapEnum(mapKey->GetKeyChar(), value);\r\n"
    "            else\r\n"
    "                obj->InsertMapEnum(mapKey->GetKeyChar(), value);\r\n"
    "            break;\r\n"
    "        case VPGObjectProperty::OrderedMapEnum:\r\n"
    "            if (obj->IsOrderedMapEnumContainKey(mapKey->GetKeyChar()))\r\n"
    "                obj->SetOrderedMapEnumByKey(mapKey->GetKeyChar(), value);\r\n"
    "            else\r\n"
    "                obj->InsertOrderedMapEnum(mapKey->GetKeyChar(), value);\r\n"
    "            break;\r\n"
    "        default:\r\n"
    "            assert(false);\r\n"
    "        }\r\n"
    ...
    "            return static_cast<long>(obj->GetVectorObj(index));\r\n"
    "        case VPGObjectProperty::OrderedMapObj:\r\n"
    "            return static_cast<long>(obj->GetOrderedMapObjByIndex(index).second);\r\n"
    "        default:\r\n"
    "            assert(false);\r\n"
    "        }\r\n"
    "    CATCH\r\n"
