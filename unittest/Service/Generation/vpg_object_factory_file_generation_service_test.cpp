...
TEST_F(VPGObjectFactoryFileGenerationServiceTest, Empty)
{
    ...
    VPGObjectFactoryFileGenerationSerive::GenerateHpp(this->GetLogProperty().get(), this->GetFilePathHpp());
    VPGObjectFactoryFileGenerationSerive::GenerateCpp(this->GetLogProperty().get(), L"VCC", {}, this->GetFilePathCpp(), propertyTypes);
...
TEST_F(VPGObjectFactoryFileGenerationServiceTest, Normal)
{
    ...
    VPGObjectFactoryFileGenerationSerive::GenerateHpp(this->GetLogProperty().get(), this->GetFilePathHpp());
    VPGObjectFactoryFileGenerationSerive::GenerateCpp(this->GetLogProperty().get(), L"VCC", { L"abc.hpp" }, this->GetFilePathCpp(), propertyTypes);
