...
TEST_F(VPGObjectFileGenerationServiceTest, Json)
{
    ...
    EXPECT_EQ(ReadFile(this->GetFilePathCpp()),
        ...
        "        // String\r\n"
        "        json->AddString(L\"String\", _String, str2wstr(_String));\r\n"
        "        // Wstring\r\n"
        "        json->AddString(L\"Wstring\", _Wstring, _Wstring);\r\n"
        "        // Vector\r\n"
        ...
        "                this->InsertVector(element->GetInt32());\r\n"
        "        }\r\n"
        "        // Map\r\n"
        "        ClearMap();\r\n"
        "        if (json->IsContainKey(L\"Map\")) {\r\n"
        "            std::shared_ptr<Json> tmpMap = json->GetObject();\r\n"
        "            std::vector<std::wstring> tmpMapKeys = tmpMap->GetKeys();\r\n"
        "            for (auto const &key : tmpMapsKeys)\r\n"
        "                this->InsertMap(std::stoi(key), tmpMap->GetInt32(key))\r\n"
        "        }\r\n"
        "        // Set\r\n"
        "        ClearSet();\r\n"
        "        if (json->IsContainKey(L\"Set\")) {\r\n"
        "            for (auto const &element : json->GetArray(L\"Set\")) {\r\n"
        "                this->InsertSet(element->GetInt32());\r\n"
        "        }\r\n"
        "        // OrderedMap\r\n"
        "        ClearOrderedMap();\r\n"
        "        if (json->IsContainKey(L\"OrderedMap\")) {\r\n"
        "            std::shared_ptr<Json> tmpOrderedMap = json->GetObject();\r\n"
        "            std::vector<std::wstring> tmpOrderedMapKeys = tmpOrderedMap->GetKeys();\r\n"
        "            for (auto const &key : tmpOrderedMapKeys)\r\n"
        "                this->InsertOrderedMap(std::stoi(key), tmpMap->GetInt32(key))\r\n"
        "        }\r\n"
        "        // Object\r\n"
        "        _Object = nullptr;\r\n"
        "        if (json->IsContainKey(L\"Object\") && !json->IsNull(L\"Object\")) {\r\n"
        "            DECLARE_SPTR(VPGGenerationOptionPlatform, platform);\r\n"
        "            _Object = json->GetObject(L\"Object\");\r\n"
        "            "
        "        }\r\n"
        "        \r\n"
        "        \r\n"
