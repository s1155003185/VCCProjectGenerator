...
TEST(JsonBuilderTest, String) {
    ...
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"name")->getJsonInternalType(),
              vcc::JsonInternalType::String);
...
TEST(JsonBuilderTest, Boolean) {
    ...
    builder->deserialize(str, json);
    EXPECT_EQ(json->getJsonInternalType(), vcc::JsonInternalType::Json);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"answer")->getJsonInternalType(),
              vcc::JsonInternalType::Boolean);
...
TEST(JsonBuilderTest, Number) {
    ...
    builder->deserialize(str, json);
    EXPECT_EQ(json->getJsonInternalType(), vcc::JsonInternalType::Json);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"age")->getJsonInternalType(),
              vcc::JsonInternalType::Number);
...
TEST(JsonBuilderTest, Object) {
    ...
    EXPECT_EQ(json->getJsonInternalType(), vcc::JsonInternalType::Json);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"Name")->getJsonInternalType(),
              vcc::JsonInternalType::Object);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"Name")
                  ->getJsonInternalArray()[0]
                  ->getJsonInternalType(),
              vcc::JsonInternalType::Json);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"Name")
                  ->getJsonInternalArray()[0]
                  ->getJsonInternalNameValuePairsAtKey(L"firstName")
                  ->getJsonInternalValue(),
              L"A");
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"Name")
                  ->getJsonInternalArray()[0]
                  ->getJsonInternalNameValuePairsAtKey(L"lastName")
                  ->getJsonInternalValue(),
              L"B");
    EXPECT_EQ(builder->serialize(json.get()), str);
}
...
TEST(JsonBuilderTest, Array) {
    std::wstring str =
        L"{\"employees\":[1,true,null,\"Str\\\"ing\",[1,2],{\"firstName\":\"A\",\"lastName\":\"B\"}"
        L"]}";
    auto builder = std::make_unique<vcc::JsonBuilder>();
    auto json = std::make_shared<vcc::Json>();
    builder->deserialize(str, json);
    EXPECT_EQ(json->getJsonInternalType(), vcc::JsonInternalType::Json);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"employees")->getJsonInternalType(),
              vcc::JsonInternalType::Array);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"employees")->getJsonInternalArray().size(),
              (size_t)6);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"employees")
                  ->getJsonInternalArray()
                  .at(0)
                  ->getJsonInternalType(),
              vcc::JsonInternalType::Number);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"employees")
...
TEST(JsonBuilderTest, Full) {
    std::wstring str =
        L"{\"name\":\"John\",\"age\":11,\"tel\":null,\"FullName\":{\"firstName\":\"A\","
        L"\"lastName\":\"B\"},\"employees\":[{\"firstName\":\"A\",\"lastName\":\"B\"},{"
        L"\"firstName\":\"C\",\"lastName\":\"D\"}]}";
    auto builder = std::make_unique<vcc::JsonBuilder>();
    auto json = std::make_shared<vcc::Json>();
    builder->deserialize(str, json);
    EXPECT_EQ(json->getJsonInternalType(), vcc::JsonInternalType::Json);
    ...
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"age")->getJsonInternalType(),
              vcc::JsonInternalType::Number);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"age")->getJsonInternalValue(), L"11");
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"tel")->getJsonInternalType(),
              vcc::JsonInternalType::Null);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"FullName")->getJsonInternalType(),
              vcc::JsonInternalType::Object);
    EXPECT_EQ(json->getJsonInternalNameValuePairsAtKey(L"employees")->getJsonInternalType(),
              vcc::JsonInternalType::Array);
    EXPECT_EQ(builder->serialize(json.get()), str);
