...
class ActionManagerTestClass final : public BaseAction
{
    ...
    protected:
        virtual std::shared_ptr<IResult> OnRedo() override { return std::make_shared<vcc::OperationResult>(); }
        virtual std::shared_ptr<IResult> OnUndo() override { return std::make_shared<vcc::OperationResult>(); }
