...
class BasePropertyAccessorTestObjectPropertyAccessor : public vcc::BasePropertyAccessor {
   protected:
    virtual std::wstring _readStringAtIndex(const int64_t& objectProperty,
    ...
    virtual void _writeStringAtIndex(const int64_t& objectProperty, const std::wstring& value,
    ...
    virtual int _readIntAtIndex(const int64_t& objectProperty,
                                const int64_t& index = -1) const override {
        assert(objectProperty == 0L);
        assert(index == -1);
        auto obj = std::static_pointer_cast<BasePropertyAccessorTestObject>(_Object);
    ...
    virtual void _writeIntAtIndex(const int64_t& objectProperty, const int& value,
                                  const int64_t& index = -1) override {
        assert(objectProperty == 0L);
        assert(index == -1);
        auto obj = std::static_pointer_cast<BasePropertyAccessorTestObject>(_Object);
    ...
    virtual std::shared_ptr<vcc::IObject> _readObject(
    ...
    virtual void _writeObjectAtIndex(const int64_t& objectProperty,
    ...
    void _insertObjectAtIndex(const int64_t& objectProperty, std::shared_ptr<vcc::IObject> value,
                              const int64_t& index) override {
        TRY assert(objectProperty == 0L);
        assert(index >= -1);
        auto obj = std::static_pointer_cast<BasePropertyAccessorTestObject>(_Object);
        assert(obj != nullptr);
        obj->insertVectorObjectAtIndex(
            index, std::static_pointer_cast<BasePropertyAccessorTestObject>(value));
        CATCH
    }

    virtual std::wstring _readStringAtKey(const int64_t& objectProperty,
    ...
    virtual void _writeStringAtKey(const int64_t& objectProperty, const std::wstring& value,
   ...
   public:
    BasePropertyAccessorTestObjectPropertyAccessor(std::shared_ptr<vcc::IObject> object)
...
TEST(BasePropertyAccessorTest, Full) {
    ...
    std::unique_ptr<BasePropertyAccessorTestObjectPropertyAccessor> accessor =
        std::make_unique<BasePropertyAccessorTestObjectPropertyAccessor>(obj);
