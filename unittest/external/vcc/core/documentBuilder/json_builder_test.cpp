...
TEST(JsonBuilderTest, Object)
{
    ...
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"Name")->GetJsonInternalArray()[0]->GetJsonInternalType(), JsonInternalType::Json);
...
TEST(JsonBuilderTest, Array)
{
    ...
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(0)->GetJsonInternalType(), JsonInternalType:: Number);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(0)->GetJsonInternalValue(), L"1");
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(1)->GetJsonInternalType(), JsonInternalType:: Boolean);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(1)->GetJsonInternalValue(), L"true");
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(2)->GetJsonInternalType(), JsonInternalType:: Null);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(3)->GetJsonInternalType(), JsonInternalType:: String);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(3)->GetJsonInternalValue(), L"Str\"ing");
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalArray().at(4)->GetJsonInternalType(), JsonInternalType:: Array);
...
TEST(JsonBuilderTest, Full)
{
    ...
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"age")->GetJsonInternalType(), JsonInternalType::Number);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"age")->GetJsonInternalValue(), L"11");
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"tel")->GetJsonInternalType(), JsonInternalType::Null);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"FullName")->GetJsonInternalType(), JsonInternalType::Object);
    EXPECT_EQ(json->GetJsonInternalNameValuePairsAtKey(L"employees")->GetJsonInternalType(), JsonInternalType::Array);
    EXPECT_EQ(builder->Serialize(json.get()), str);
}
