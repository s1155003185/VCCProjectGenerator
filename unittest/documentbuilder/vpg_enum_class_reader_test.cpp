...
TEST(VPGEnumClassReaderTest, EnumClassWithManager)
{
    ...
    EXPECT_EQ(element->GetProperties().at(4)->GetActionResultClass(), L"OperationResult");
    ...
    EXPECT_EQ(element->GetProperties().at(5)->GetActionResultClass(), L"OperationResult");
    ...
    EXPECT_EQ(element->GetProperties().at(6)->GetActionResultClass(), L"ActionResult");
}
