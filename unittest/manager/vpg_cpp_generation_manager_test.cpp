...
TEST_F(VPGCppGenerationManagerTest, Add) {
    ...
    // ProcessService::execute(this->getLogConfig().get(), L"", this->getWorkspaceTarget(),
    // L"make"); EXPECT_TRUE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
    // L"bin/Debug/"), L"CPPProject.exe"))
    //     || IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(), L"bin/Debug/"),
    //     L"CPPProject")));
    // EXPECT_TRUE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
    // L"bin/Debug/"), L"CPPDllProject.dll"))
    //     || IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(), L"bin/Debug/"),
    //     L"CPPDllProject.so")));
    // EXPECT_TRUE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
    // L"bin/Debug/"), L"CPPUnitTest.exe"))
    //     || IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(), L"bin/Debug/"),
    //     L"CPPUnitTest")));
    ...
    //     || IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(), L"bin/Debug/"),
    //     L"CPPProject")));
    // EXPECT_FALSE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
    // L"bin/Debug/"), L"CPPDllProject.dll"))
    //     || IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(), L"bin/Debug/"),
    //     L"CPPDllProject.so")));
    // EXPECT_TRUE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
    ...
    EXPECT_TRUE(isDirectoryExists(concatPaths({this->getWorkspaceTarget(), L"unittest"})));
    // ProcessService::execute(this->getLogConfig().get(), L"", this->getWorkspaceTarget(),
    // L"make"); EXPECT_FALSE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
    // L"bin/Debug/"), L"CPPProject.exe"))
    //     || IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(), L"bin/Debug/"),
    //     L"CPPProject")));
    // EXPECT_TRUE(IsFilePresent(ConcatPaths({ConcatPaths({this->getWorkspaceTarget(),
