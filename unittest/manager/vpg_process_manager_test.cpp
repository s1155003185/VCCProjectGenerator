...
TEST_F(VPGProcessManagerTest, Version) { this->getManager()->execute({L"vpg", L"-Version"}); }

// TEST_F(VPGProcessManagerTest, AddUpdateGenerate)
// {
//     this->getManager()->execute({L"vpg", L"-Add", L"-interface", L"CPPCOMPLEX",
//     L"-workspace-destination", this->getWorkspace()});
