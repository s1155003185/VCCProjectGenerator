...
TEST_F(VPGFileGenerationManagerTest, GenerateProperty)
{
    ...
    EXPECT_EQ(ReadFile(ConcatPaths({this->GetWorkspaceTarget(), L"vcc_a_property_accessor.cpp"})),
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        std::shared_ptr<VCCObject> obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        std::shared_ptr<VCCObjectPtr> obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
