...
TEST_F(VPGFileGenerationManagerTest, GenerateProperty)
{
    ...
    EXPECT_EQ(ReadFile(ConcatPaths({this->GetWorkspaceTarget(), L"vcc_a_property_accessor.cpp"})),
        ...
        "using namespace vcc;\r\n"
        "\r\n"
        "long VCCObjectPropertyAccessor::_ReadLong(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "long VCCObjectPropertyAccessor::_ReadLong(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        ...
        "}\r\n"  
        "\r\n"
        "void VCCObjectPropertyAccessor::_WriteLong(const int64_t &objectProperty, const long &value, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_WriteLong(const int64_t &objectProperty, const long & /*value*/, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_InsertLong(const int64_t &objectProperty, const long &value, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        ...
        "        case VCCObjectProperty::EnumE:\r\n"
        "            if (index > -1)\r\n"
        "                obj->InsertEnumE(index, static_cast<ExceptionType>(value));\r\n"
        "            else\r\n"
        "                obj->InsertEnumE(static_cast<ExceptionType>(value));\r\n"
        "            break;\r\n"
        "        default:\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::wstring VCCObjectPropertyAccessor::_ReadString(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::wstring VCCObjectPropertyAccessor::_ReadString(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_WriteString(const int64_t &objectProperty, const std::wstring &value, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_WriteString(const int64_t &objectProperty, const std::wstring & /*value*/, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_InsertString(const int64_t &objectProperty, const std::wstring & /*value*/, const int64_t & /*index*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "size_t VCCObjectPropertyAccessor::_GetContainerCount(const int64_t &objectProperty) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        "        assert(obj != nullptr);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_RemoveContainerElement(const int64_t &objectProperty, const IObject * /*value*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_RemoveContainerElementAtIndex(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_RemoveContainerElementAtKey(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "void VCCObjectPropertyAccessor::_ClearContainer(const int64_t &objectProperty) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        auto obj = std::static_pointer_cast<VCCObject>(_Object);\r\n"
        "        assert(obj != nullptr);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::shared_ptr<IObject> VCCObjectPtrPropertyAccessor::_ReadObject(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::shared_ptr<IObject> VCCObjectPtrPropertyAccessor::_ReadObject(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_WriteObject(const int64_t &objectProperty, std::shared_ptr<IObject> value, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_WriteObject(const int64_t &objectProperty, std::shared_ptr<IObject> /*value*/, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_InsertObject(const int64_t &objectProperty, std::shared_ptr<IObject> value, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        ...
        "        case VCCObjectPtrProperty::EnumC:\r\n"
        "            if (index > -1)\r\n"
        "                obj->InsertEnumC(index, std::static_pointer_cast<Json>(value));\r\n"
        "            else\r\n"
        "                obj->InsertEnumC(std::static_pointer_cast<Json>(value));\r\n"
        "            break;\r\n"
        "        default:\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::shared_ptr<IObject> VCCObjectPtrPropertyAccessor::_CloneObject(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "std::shared_ptr<IObject> VCCObjectPtrPropertyAccessor::_CloneObject(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        ...
        "}\r\n"
        "\r\n"
        "size_t VCCObjectPtrPropertyAccessor::_GetContainerCount(const int64_t &objectProperty) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        auto obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        "        assert(obj != nullptr);\r\n"
        ...
        "        {\r\n"
        "        case VCCObjectPtrProperty::EnumC:\r\n"
        "            obj->RemoveEnumC(const_cast<IObject*>(value)->GetSharedPtr());\r\n"
        "            break;\r\n"
        "        default:\r\n"
        "            assert(false);\r\n"
        "        }\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_RemoveContainerElementAtIndex(const int64_t &objectProperty, const int64_t &index) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        assert(index >= -1);\r\n"
        "        auto obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        ...
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_RemoveContainerElementAtKey(const int64_t &objectProperty, const void * /*key*/) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        THROW_EXCEPTION_MSG_FOR_BASE_PROPERTY_ACCESSOR_DETAIL_PROPERTY_NOT_FOUND\r\n"
        "    CATCH\r\n"
        "}\r\n"
        "\r\n"
        "void VCCObjectPtrPropertyAccessor::_ClearContainer(const int64_t &objectProperty) const\r\n"
        "{\r\n"
        "    TRY\r\n"
        "        auto obj = std::static_pointer_cast<VCCObjectPtr>(_Object);\r\n"
        "        assert(obj != nullptr);\r\n"
