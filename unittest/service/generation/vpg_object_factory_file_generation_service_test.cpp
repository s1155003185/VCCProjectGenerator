...
TEST_F(VPGObjectFactoryFileGenerationServiceTest, Empty) {
    ...
    VPGObjectFactoryFileGenerationService::generateHpp(this->getLogConfig().get(),
                                                       this->getFilePathHpp());
    VPGObjectFactoryFileGenerationService::generateCpp(this->getLogConfig().get(), L"VCC", {},
                                                       this->getFilePathCpp(), propertyTypes);
