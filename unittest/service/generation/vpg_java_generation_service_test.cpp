...
TEST_F(VPGJavaGenerationServiceTest, GenerateJavaBridge)
{
    ...
    EXPECT_EQ(ReadFile(ConcatPaths({this->GetWorkspace(), this->GetJavaOption()->GetDllBridgeDirectory(), L"VPGDllFunctions.java"})),
        ...
        "    void RemoveContainerElementAtIndex(Pointer ref, long property, long index);\r\n"
...
{   
    ...
    EXPECT_EQ(ReadFile(filePath),
        ...
        "        VPGDllFunctions.Instance.RemoveContainerElementAtIndex(Handle, VPGTypeBProperty.VectorDouble.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        VPGDllFunctions.Instance.RemoveContainerElementAtIndex(Handle, VPGTypeBProperty.VectorString.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        VPGDllFunctions.Instance.RemoveContainerElementAtIndex(Handle, VPGTypeBProperty.VectorObject.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
        ...
        "        VPGDllFunctions.Instance.RemoveContainerElementAtIndex(Handle, VPGTypeBProperty.OrderedMapObject.getValue(), index);\r\n"
        "    }\r\n"
        "\r\n"
