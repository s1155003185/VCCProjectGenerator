...
TEST_F(VPGObjectFileGenerationServiceTest, FormAction)
{
    ...
    EXPECT_EQ(vcc::ReadFile(this->GetFilePathHpp()), 
        ...
        "        VPGGitFormAddWorkspace(std::shared_ptr<LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm);\r\n"
        ...
        "        VPGGitFormDeleteWorkspace(std::shared_ptr<LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm);\r\n"
        "        VPGGitFormDeleteWorkspace(std::shared_ptr<LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm, std::shared_ptr<VPGGitFormDeleteWorkspaceArgument> argument);\r\n"
    ...
    EXPECT_EQ(vcc::ReadFile(this->GetFilePathCpp()),
        ...
        "// </vcc:customHeader>\r\n"
        "\r\n"
        "VPGGitFormAddWorkspace::VPGGitFormAddWorkspace(std::shared_ptr<LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm) : BaseAction()\r\n"
        "{\r\n"
        ...
        "}\r\n"
        "\r\n"
        "VPGGitFormDeleteWorkspace::VPGGitFormDeleteWorkspace(std::shared_ptr<LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm) : BaseAction()\r\n"
        "{\r\n"
        "    _LogConfig = logConfig;\r\n"
        "    _ParentObject = parentForm;\r\n"
        "}\r\n"
        "\r\n"
        "VPGGitFormDeleteWorkspace::VPGGitFormDeleteWorkspace(std::shared_ptr<LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm, std::shared_ptr<VPGGitFormDeleteWorkspaceArgument> argument) : BaseAction()\r\n"
        "{\r\n"
        "    _LogConfig = logConfig;\r\n"
        "    _ParentObject = parentForm;\r\n"
        "    _Argument = argument;\r\n"
