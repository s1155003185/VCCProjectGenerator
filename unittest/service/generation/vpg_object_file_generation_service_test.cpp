...
TEST_F(VPGObjectFileGenerationServiceTest, FormAction)
{
    ...
    EXPECT_EQ(ReadFile(this->GetFilePathCpp()),
        ...
        "{\r\n"
        "    TRY\r\n"
        "        auto action = std::make_shared<VPGGitFormAddWorkspace>(_LogConfig, GetSharedPtr());\r\n"
        ...
        "{\r\n"
        "    TRY\r\n"
        "        auto action = std::make_shared<VPGGitFormWorkNormal>(_LogConfig, GetSharedPtr(), L\"\", State::Busy);\r\n"
        ...
        "{\r\n"
        "    TRY\r\n"
        "        auto action = std::make_shared<VPGGitFormDeleteWorkspace>(_LogConfig, GetSharedPtr());\r\n"
