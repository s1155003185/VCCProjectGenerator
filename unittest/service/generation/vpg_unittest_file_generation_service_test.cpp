...
class VPGUnittestFileGenerationServiceTest : public testing::Test, public vcc::BaseObject
{
    ...
    public:
        void SetUp() override
        {
            ...
            this->_EnumClassWithNamespace = L""
                "#pragma once\r\n"
                "\r\n"
                "namespace Namespace {\r\n"
                "    //@@Form\r\n"
...
TEST_F(VPGUnittestFileGenerationServiceTest, GenerateUnittest_Action)
{
    VPGUnittestFileGenerationService::generateCppAction(
        this->getLogConfig().get(),
        L"VPG",
        this->getOriginalPropertyFilePath(),
        this->getWorkspace(),
        this->getEnumClassList(),
        { L"TestAction1", L"TestAction2" },
        false
    );
    EXPECT_TRUE(vcc::isFilePresent(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_action_test.cpp"})));
    EXPECT_EQ(vcc::readFile(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_action_test.cpp"})), L""
        ...
        "        void TearDown() override\r\n"
        "        {\r\n"
        "            // <vcc:customVPGGitFormActionTestTearDown sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormActionTestVPGGitFormAddWorkspace_TestAction1 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormActionTestVPGGitFormAddWorkspace_TestAction2 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormActionTestVPGGitFormDeleteWorkspace_TestAction1 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormActionTestVPGGitFormDeleteWorkspace_TestAction2 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
...
TEST_F(VPGUnittestFileGenerationServiceTest, GenerateUnittest_Action_SeperatedFile)
{
    ...
    EXPECT_TRUE(vcc::isFilePresent(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_add_workspace_test.cpp"})));
    EXPECT_TRUE(vcc::isFilePresent(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_delete_workspace_test.cpp"})));

    EXPECT_EQ(vcc::readFile(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_add_workspace_test.cpp"})), L""
        "// <vcc:vccproj sync=\"FULL\" gen=\"FULL\"/>\r\n"
        "#include <gtest/gtest.h>\r\n"
        "\r\n"
        "// <vcc:customHeader sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormAddWorkspaceTestProperties sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        ...
        "        void SetUp() override\r\n"
        "        {\r\n"
        "            // <vcc:customVPGGitFormAddWorkspaceTestSetUp sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "            // </vcc:customVPGGitFormAddWorkspaceTestSetUp>\r\n"
        "        }\r\n"
        "\r\n"
        "        void TearDown() override\r\n"
        "        {\r\n"
        "            // <vcc:customVPGGitFormAddWorkspaceTestTearDown sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "            // </vcc:customVPGGitFormAddWorkspaceTestTearDown>\r\n"
        "        }\r\n"
        "\r\n"
        "        // <vcc:customVPGGitFormAddWorkspaceTestFunctions sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "        // </vcc:customVPGGitFormAddWorkspaceTestFunctions>\r\n"
        "};\r\n"
        "\r\n"
        "TEST_F(VPGGitFormAddWorkspaceTest, TestAction1)\r\n"
        "{\r\n"
        "    // <vcc:customVPGGitFormAddWorkspaceTestTestAction1 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormAddWorkspaceTestTestAction2 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
        "    // </vcc:customVPGGitFormAddWorkspaceTestTestAction2>\r\n"
        "};\r\n");
    EXPECT_EQ(vcc::readFile(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_delete_workspace_test.cpp"})), L""
        "// <vcc:vccproj sync=\"FULL\" gen=\"FULL\"/>\r\n"
        "#include <gtest/gtest.h>\r\n"
        "\r\n"
        "// <vcc:customHeader sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormDeleteWorkspaceTestProperties sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        ...
        "        void SetUp() override\r\n"
        "        {\r\n"
        "            // <vcc:customVPGGitFormDeleteWorkspaceTestSetUp sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "            // </vcc:customVPGGitFormDeleteWorkspaceTestSetUp>\r\n"
        "        }\r\n"
        "\r\n"
        "        void TearDown() override\r\n"
        "        {\r\n"
        "            // <vcc:customVPGGitFormDeleteWorkspaceTestTearDown sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "            // </vcc:customVPGGitFormDeleteWorkspaceTestTearDown>\r\n"
        "        }\r\n"
        "\r\n"
        "        // <vcc:customVPGGitFormDeleteWorkspaceTestFunctions sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "        // </vcc:customVPGGitFormDeleteWorkspaceTestFunctions>\r\n"
        "};\r\n"
        "\r\n"
        "TEST_F(VPGGitFormDeleteWorkspaceTest, TestAction1)\r\n"
        "{\r\n"
        "    // <vcc:customVPGGitFormDeleteWorkspaceTestTestAction1 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
        ...
        "{\r\n"
        "    // <vcc:customVPGGitFormDeleteWorkspaceTestTestAction2 sync=\"RESERVE\" gen=\"RESERVE\">\r\n"
        "    // TODO: Implement test case\r\n"
...
TEST_F(VPGUnittestFileGenerationServiceTest, GenerateUnittest_Action_Namespace)
{
    VPGUnittestFileGenerationService::generateCppAction(
        ...
        this->getOriginalPropertyFilePath(),
        this->getWorkspace(),
        this->getEnumClassListWithNamespace(),
        { L"TestAction1", L"TestAction2" },
        false
    );
    EXPECT_TRUE(vcc::isFilePresent(vcc::concatPaths({this->getWorkspace(), L"vpg_git_form_action_test.cpp"})));
