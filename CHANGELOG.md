...
- Support GETCUSTOM_VECTOR, GETCUSTOM_VECTOR_SPTR, SETCUSTOM_VECTOR, SETCUSTOM_VECTOR_SPTR
- Support GETCUSTOM_MAP, GETCUSTOM_MAP_SPTR, SETCUSTOM_MAP, SETCUSTOM_MAP_SPTR
- Support GETCUSTOM_ORDERED_MAP, GETCUSTOM_ORDERED_MAP_SPTR, SETCUSTOM_ORDERED_MAP, SETCUSTOM_ORDERED_MAP_SPTR
- Support one enum with multi class macro
- Class Enum support @@Include @@Private @@Protected
