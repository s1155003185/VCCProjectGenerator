...
void VPGObjectFactoryFileGenerationService::generateHpp(const vcc::LogConfig* logConfig,
                                                        const std::wstring& filePathHpp) {
    TRY vcc::LogService::logInfo(logConfig, logId, L"Generate object factory file: " + filePathHpp);
    std::wstring content =
        L""
        "#pragma once\r\n"
        "\r\n"
...
void VPGObjectFactoryFileGenerationService::generateCpp(
    ...
    TRY vcc::LogService::logInfo(logConfig, logId, L"Generate object factory file: " + filePathCpp);
