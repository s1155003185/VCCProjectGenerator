...
{
    TRY
    vcc::LogService::logInfo(logConfig, logId, L"Generate property accessor factory file: " + filePathHpp);
    ...
    vcc::LogService::logInfo(logConfig, logId, L"Generate property accessor factory file completed.");
    CATCH
}
...
{
    TRY
    vcc::LogService::logInfo(logConfig, logId, L"Generate property accessor factory file: " + filePathCpp);
