...
VPGMainFormAddWorkspaceForm::VPGMainFormAddWorkspaceForm(std::shared_ptr<vcc::LogConfig> logConfig,
...
VPGMainFormAddWorkspaceForm::VPGMainFormAddWorkspaceForm(
    std::shared_ptr<vcc::LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm,
    std::shared_ptr<VPGMainFormAddWorkspaceFormArgument> argument)
    : vcc::BaseAction() {
    _LogConfig = logConfig;
    _ParentObject = parentForm;
    _Argument = argument;
...
VPGMainFormDeleteWorkspaceForm::VPGMainFormDeleteWorkspaceForm(
    std::shared_ptr<vcc::LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm)
    : vcc::BaseAction() {
    _LogConfig = logConfig;
    _ParentObject = parentForm;
...
VPGMainFormDeleteWorkspaceForm::VPGMainFormDeleteWorkspaceForm(
    std::shared_ptr<vcc::LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm,
    std::shared_ptr<VPGMainFormDeleteWorkspaceFormArgument> argument)
    : vcc::BaseAction() {
    _LogConfig = logConfig;
    _ParentObject = parentForm;
    _Argument = argument;
...
std::shared_ptr<vcc::IResult> VPGMainFormDeleteWorkspaceForm::onRedo() {
    ...
    if (index < 0) THROW_EXCEPTION_MSG(ExceptionType::CustomError, L"Workspace not found");
...
VPGMainFormInitialize::VPGMainFormInitialize(std::shared_ptr<vcc::LogConfig> logConfig,
                                             std::shared_ptr<vcc::IObject> parentForm)
    : vcc::BaseAction() {
    _LogConfig = logConfig;
    _ParentObject = parentForm;
...
std::shared_ptr<vcc::IResult> VPGMainFormInitialize::onRedo() {
    ...
    if (vcc::isFilePresent(configFilePath)) {
        ...
        CATCH_MSG(ExceptionType::ParserError,
                  L"File " + configFilePath +
                      L" exists but not vaild. Please adjust / remove the file and try again")
    } else {
...
VPGMainFormRenameWorkspaceForm::VPGMainFormRenameWorkspaceForm(
    std::shared_ptr<vcc::LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm)
    : vcc::BaseAction() {
    _LogConfig = logConfig;
    _ParentObject = parentForm;
...
VPGMainFormRenameWorkspaceForm::VPGMainFormRenameWorkspaceForm(
    std::shared_ptr<vcc::LogConfig> logConfig, std::shared_ptr<vcc::IObject> parentForm,
    std::shared_ptr<VPGMainFormRenameWorkspaceFormArgument> argument)
    : vcc::BaseAction() {
    _LogConfig = logConfig;
    _ParentObject = parentForm;
    _Argument = argument;
...
std::shared_ptr<vcc::IResult> VPGMainFormRenameWorkspaceForm::onRedo() {
    TRY
        ...
        CATCH_RETURN_RESULT(vcc::OperationResult) return std::make_shared<vcc::OperationResult>();
}

VPGMainForm::VPGMainForm() : vcc::BaseForm() {
    TRY _ObjectType = ObjectType::MainForm;
    initialize();
    CATCH
}
...
std::shared_ptr<vcc::Json> VPGMainForm::toJson() const {
    ...
    json->addArray(
        vcc::convertNamingStyle(L"WorkspaceForms", vcc::NamingStyle::PascalCase, namestyle),
        tmpWorkspaceForms);
...
void VPGMainForm::deserializeJson(std::shared_ptr<vcc::IDocument> document) {
    ...
    if (json->isContainKey(
            vcc::convertNamingStyle(L"WorkspaceForms", namestyle, vcc::NamingStyle::PascalCase))) {
        for (auto const& element : json->getArray(vcc::convertNamingStyle(
                 L"WorkspaceForms", namestyle, vcc::NamingStyle::PascalCase))) {
...
void VPGMainForm::initializeComponents() {
    TRY vcc::BaseForm::initializeComponents();
    _LogConfig = nullptr;
...
std::shared_ptr<vcc::IResult> VPGMainForm::doAction(const int64_t& formProperty,
                                                    std::shared_ptr<vcc::IObject> argument) {
    TRY switch (static_cast<VPGMainFormProperty>(formProperty)) {
        case VPGMainFormProperty::Initialize:
            return doInitialize();
        case VPGMainFormProperty::AddWorkspaceForm:
            return doAddWorkspaceForm(
                std::dynamic_pointer_cast<VPGMainFormAddWorkspaceFormArgument>(argument));
        case VPGMainFormProperty::DeleteWorkspaceForm:
            return doDeleteWorkspaceForm(
                std::dynamic_pointer_cast<VPGMainFormDeleteWorkspaceFormArgument>(argument));
        case VPGMainFormProperty::RenameWorkspaceForm:
            return doRenameWorkspaceForm(
                std::dynamic_pointer_cast<VPGMainFormRenameWorkspaceFormArgument>(argument));
        default:
            assert(false);
            break;
    }
...
std::shared_ptr<vcc::IResult> VPGMainForm::doInitialize() {
    TRY auto action = std::make_shared<VPGMainFormInitialize>(_LogConfig, sharedPtr());
...
std::shared_ptr<vcc::IResult> VPGMainForm::doAddWorkspaceForm(
    std::shared_ptr<VPGMainFormAddWorkspaceFormArgument> argument) {
    TRY auto action =
        std::make_shared<VPGMainFormAddWorkspaceForm>(_LogConfig, sharedPtr(), argument);
...
std::shared_ptr<vcc::IResult> VPGMainForm::doDeleteWorkspaceForm(
    std::shared_ptr<VPGMainFormDeleteWorkspaceFormArgument> argument) {
    TRY auto action =
        std::make_shared<VPGMainFormDeleteWorkspaceForm>(_LogConfig, sharedPtr(), argument);
...
std::shared_ptr<vcc::IResult> VPGMainForm::doRenameWorkspaceForm(
    std::shared_ptr<VPGMainFormRenameWorkspaceFormArgument> argument) {
    TRY auto action =
        std::make_shared<VPGMainFormRenameWorkspaceForm>(_LogConfig, sharedPtr(), argument);
...
void VPGMainForm::saveConfig() const {
    TRY auto jsonBuilder = std::make_unique<vcc::JsonBuilder>();
    jsonBuilder->setIsBeautify(true);
    vcc::writeFile(VPGGlobal::getVCCProjectManagerConfigFileFullPath(),
                   serializeJson(jsonBuilder.get()), true);
    CATCH
}
// </vcc:customFunctions>
